...
\title{Case study: the board game Go In Scala and Leon}
...
\begin{abstract}
    ...
    In this case study, we implemented Go in Leon with the objective to answer the question: how practical is it to use Leon to program a correct implementation of Go?
    Our experiments reveal that it is indeed useful to to annotate a Scala codebase with Leon verification conditions.
    Still, we consider that Leon has plenty of room for improvement to make it easier to verify non-trivial properties about your programs.
\end{abstract}
...
In this project, we implemented the ancient Chinese board game Go. The main

...
\begin{itemize}
    ...
    \item Not so obvious corner cases were detected by our unit tests while Leon timed out, see TODO.
...
Leon could not infer that if the \texttt{board.isValidPoints} hold for two lists, then it also holds for the concatenation of those lists.
...
algorithm is as follows:
 ...
 The DFS algorithm looks like follows:

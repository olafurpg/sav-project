...
Currently the Leon web interface shows counterexamples in a dialog, or in a tip when user hovers the pointer over a variable. This is unfriendly, as the programmer has to remember the variable values and do substitution and execution in mind in order to reason where the problem lies.

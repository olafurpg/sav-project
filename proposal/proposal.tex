...
\begin{abstract}
    ...
    We propose to integrate Scala.js with Leon and implement ideas from Bret Victor's essay on ``Learnable Programming'' \footnote{\url{http://worrydream.com/\#!/LearnableProgramming}} to improve experience for users when presented with a counterexample.

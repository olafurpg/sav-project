...
\tikzstyle{block} = [rectangle, draw, fill=mygreen!20, text centered, rounded corners, minimum height=1em]
...
\begin{frame}[fragile]{Set $L$ with \alert{meet} operation $\wedge$}
    \begin{align*}
...
\begin{frame}[fragile]{}
    \begin{definition}
        Element $e \in L$ is called \alert{zero}, labeled 0 (analogous to $\bot$), if
        \[
    ...
    \pause
    \begin{definition}
        Element $e \in L$ is called \alert{one}, labeled 1(analogous to $\top$), if
        \[
...
\begin{frame}[fragile]{Monotone function space} % {Chain $x_1, x_2, \ldots, x_n$}
    \begin{definition}
        Given a bounded semilattice $L$, a set of functions $F$ on $L$ is said
        to be a monotone function space associated with $L$ if the
        following conditions are satisfied:
        \begin{enumerate}
            \item[M1] Each $f \in F$ satisfies the \alert{monotonicity condition},
                \[
...
\begin{frame}[fragile]{Monotone data flow analysis framework} % {Chain $x_1, x_2, \ldots, x_n$}
    \begin{definition}
    ...
    \end{definition}
\end{frame}
\begin{frame}[fragile]{Framework instance} % {Chain $x_1, x_2, \ldots, x_n$}
    \begin{definition}
  ...
  \begin{columns}[onlytextwidth]
    ...
    \begin{column}{0.5\textwidth}
        \begin{center}
            ...
            \node [block, below of=n1, label=130:$n_3$, xshift=1cm] (n3) {$C = A + B$};
      ...
      \begin{center}
        ...
        \only<2>{
          \begin{tikzpicture}[node distance = 2cm, auto, every text node part/.style={align=left}]
            ...
            \node [value, left of=n1, node distance=0.9cm] (s1) {\tiny 1};
            \node [block, below of=n0, label=above:$n_2$, xshift=0.8cm] (n2) {$A = 3$\\$B = 2$};
            \node [value, right of=n2, node distance=1.3cm] (s2) {\tiny A=3,  B=2};
            \node [block, below of=n1, label=130:$n_3$, xshift=1cm] (n3) {$C = A + B$};
            \node [value, right of=n3, node distance=1.3cm] (s3) {\tiny 1};
            % Draw edges
            \path [line] (n0) -- (n1);
        ...
        \only<3>{
          \begin{tikzpicture}[node distance = 2cm, auto, every text node part/.style={align=left}]
            ...
            \node [value, right of=n0, node distance=1.1cm] (s0) {\tiny A=1};
            \node [block, below of=n0, label=above:$n_1$, xshift=-0.8cm] (n1) {$A = 2$\\$B = 3$};
            \node [value, left of=n1, node distance=1.3cm] (s1) {\tiny A=2, B=3};
            \node [block, below of=n0, label=above:$n_2$, xshift=0.8cm] (n2) {$A = 3$\\$B = 2$};
            \node [value, right of=n2, node distance=1.3cm] (s2) {\tiny A=3,  B=2};
            \node [block, below of=n1, label=130:$n_3$, xshift=1cm] (n3) {$C = A + B$};
            \node [value, right of=n3, node distance=1.3cm] (s3) {\tiny 1};
        ...
        \only<4>{
          \begin{tikzpicture}[node distance = 2cm, auto, every text node part/.style={align=left}]
            ...
            \node [value, right of=n2, node distance=1.3cm] (s2) {\tiny A=3,  B=2};
            \node [block, below of=n1, label=130:$n_3$, xshift=1cm] (n3) {$C = A + B$};
            \node [value, right of=n3, node distance=1.5cm] (s3) {\tiny C=5};
            % Draw edges
            \path [line] (n0) -- (n1);
            \path [line] (n0) -- (n2);
            \path [line] (n1) -- (n3);

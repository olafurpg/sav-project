...
\begin{frame}
  ...
  \begin{theorem}
    ...
    \begin{enumerate}[(i)]
    \item Algorithm 2 will eventually halt. \alert{\scriptsize proof: A[n]
        decrease and L is bounded}.
    \item $(\forall n \in N) A[n] \leqq \bigwedge_{P \in PATH(n)}f_P(0)$.
    ...
    \item There're cases where A[n] is strictly less than MOP when the data flow graph is monotone. \alert{\scriptsize proof: illustrated in the example}.
    \end{enumerate}
  \end{theorem}
\end{frame}
